                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="?p=aluno/excluir&id=<?= $mostrar['rm_aluno'] ?>" class="btn btn-danger" title="Excluir" data-confirm="">
                                    <i class="bi bi-x-circle"></i>
                                </a>
                                <a href="?p=aluno/salvar&id=<?= $mostrar['rm_aluno'] ?>" class="btn btn-secondary" title="Editar">
